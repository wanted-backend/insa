...
from .views import UserEmailExists, UserRegisterView, AdminRegisterView, LogInView, CompanyLikedResumes, ResumeView, UserResumeWriteView, ResumeDetailWriteView, ResumeDetailView, CareerResultView, ResumeMainView, CompanyRequestsResume, CompanyInterviewResume
...
urlpatterns = [
	...
	path('/login', LogInView.as_view()),
        path('/likes', CompanyLikedResumes.as_view()),
